...
<table width="100%">
    ...
    <table width="100%">
    	<tbody><tr class="yel">
        	<td width="45%">動態文字廣告</td><td width="7%">顯示</td><td width="7%">刪除</td>
                    </tr>
                    <?php
$rows = $DB->all();
foreach($rows as $row){
...
?>
     ...
     <tbody><tr>
      <td width="200px"><input type="button" onclick="op('#cover','#cvr','./modal/addtext.php?do=<?=$do?>')" value="新增動態文字廣告"></td><td class="cent"><input type="submit" value="修改確定"><input type="reset" value="重置"></td>
     </tr>
    </tbody></table>    
