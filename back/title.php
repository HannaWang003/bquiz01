...
<tr>
        ...
        <input type="hidden" name="id[]" value="<?=$row['id']?>">
            ...
            <td><input type="button" onclick="op('#cover','#cvr','./modal/upload.php?do=<?=$do?>&id=<?=$row['id']?>')" value="更新圖片"></td>
                    </tr>
...
?>
     ...
     <tbody><tr>
      <td width="200px"><input type="button" onclick="op('#cover','#cvr','./modal/upload.php?do=<?=$do?>')" value="新增網站標題圖片"></td><td class="cent">
