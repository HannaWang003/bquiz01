...
(14, 'admin', '81dc9bdb52d04dc20036dbd8313ed055'),
(15, 'admin_test', '12345');
...
(8, '網站首頁', 'index.php', 1, 0),
(9, '管理登入', 'index.php?do=login', 1, 0),
(15, '更多內容', '?do=news', 1, 8),
(16, 'aaa', 'adsfadf', 1, 8),
(17, 'ab', '', 1, 9),
(18, 'adsfad', 'adsfadf', 1, 9),
(20, 'test1-1', 'test-1-1', 1, 19),
(21, 'test1-2', 'test-1-2', 1, 19);
